...
const PictureCarouselCard=()=>{
    return(
        <>
        <div className="w-full h-64 relative px-4 overflow-hodden">
            <div className="w-full h-full relative">
           <img 
           src="https://b.zmtcdn.com/data/pictures/1/19823701/02ed2d8fc29b03df82310279326cda52.jpg?output-format=webp&fit=around|771.75:416.25&crop=771.75:416.25;*,*"
           alt="food"
        ...
        <div className="absolute w-full left-8 bottom-2 text-white">
            <h4 className="z-10">Taco Bell</h4>
