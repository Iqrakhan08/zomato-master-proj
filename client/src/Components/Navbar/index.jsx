...
const MobileNav=({SignIn,SignUp})=>{
    ...
    return(
     ...
     <div className="flex items-center gap-3 relative">
         <button className="bg-zomato-400 text-white py-2 px-3 rounded-full">Use App
         </button>
     <span 
...
const LargeNav=({SignIn,SignUp})=>{
    ...
    <div className="hidden gap-4 w-full items-center justify-around lg:flex">
     ...
     <div className="ml-28 flex gap-4">
         <button
         onClick={SignIn}
         className="text-gray-500 text-xl hover:text-gray-800">Login</button>
         <button
         onClick={SignUp}
         className="text-gray-500 text-xl hover:text-gray-800">Signup </button>
     </div>
     </div>
     </div>
    </>
